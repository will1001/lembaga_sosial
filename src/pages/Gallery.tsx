    ...
    <div className="pt-24">
      ...
      <section className="py-16 bg-gradient-to-r from-yellow-500 to-yellow-400">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Dokumentasi berbagai kegiatan dan program Cahaya Untuk Negeri di seluruh Indonesia.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Tertarik untuk <span className="text-yellow-500">Bergabung?</span></h2>
          <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
            Ikuti kegiatan Cahaya Untuk Negeri berikutnya dengan menjadi relawan atau donatur. Kami sangat mengapresiasi setiap kontribusi.
          </p>
